...
from gr00t.utils.eval import get_and_send_action
...
class ArgsConfig:
    ...
    model_path: str = "/mnt/sdc/bch/forBenchmark/Isaac-GR00T/exp/gr00t_hand/unity0916:00_train_1.0_cam_18dim"
    """Path to the model checkpoint."""
    
    denoising_steps: int = 4
    """Number of denoising steps to use."""

    evaluation_output_path: str = "/mnt/sdc/bch/forBenchmark/Isaac-GR00T/evaluation_results"
...
def main(args: ArgsConfig):
    ...
    # basemodel
    traj_store_path = os.path.join(args.evaluation_output_path, "trajectories", f"{additional_info_data}:{additional_info_model}")
    metrics_json_path = os.path.join(args.evaluation_output_path, f"results_{additional_info_data}:{additional_info_model}.jsonl")
    ...
    for traj_id in args.trajs:
        ...
        for i in range(args.repeat_num):
            ...
            get_and_send_action(
                    ...
                    steps=trajectory_lengths[traj_id],
