...
# class ManoDataConfig(BaseDataConfig):
#     video_keys = ["video.ego_view"]
#     action_keys = [
#         "action.left_hand",
#     ]
...
class ManoDataConfig2(BaseDataConfig):
    video_keys = ["video.ego_view"]
    action_keys = [
        "action.left_hand",
    ]
    ...
    language_keys = ["annotation.human.action.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))    # 预测未来的多少步
...
class ManoDataConfig2_baseline(BaseDataConfig):
    video_keys = ["video.ego_view"]
    action_keys = [
        "action.left_hand",
    ]
    ...
    language_keys = ["annotation.human.action.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))    # Will be updated by args.action_horizon
...
class ManoDataConfig2_motion_hint(BaseDataConfig):
    video_keys = ["video.ego_view"]
    action_keys = [
        "action.left_hand",
    ]
...
class ManoDataConfig2_baseline_motion_hint(BaseDataConfig):
    video_keys = ["video.ego_view"]
    action_keys = [
        "action.left_hand",
    ]
